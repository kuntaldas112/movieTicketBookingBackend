...
import com.fse1.movieapp.payload.request.SignupRequest;
import com.fse1.movieapp.payload.response.JwtResponse;
...
import com.fse1.movieapp.security.jwt.JwtUtils;
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        if (userRepository.existsByLoginId(signUpRequest.getLoginId())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("LoginId is already taken!","Error"));
        }

        if (userRepository.existsByEmail(signUpRequest.getEmail())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Email is already in use!","Error"));
        }
